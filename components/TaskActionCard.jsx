...
const TaskActionCard = React.forwardRef(
  (
    {
      href = '/',
      onAddButtonClick,
      ...
      <div className="rounded-md p-3 pr-2 bg-white h-[200px] relative">
        ...
        {leftChevronIcon ? (
          <div
            ...
            className={`absolute -left-[3%] top-1/2 transform -translate-y-1/2 w-fit h-fit rounded-full `}
          >
            <IoChevronBackCircleSharp
              className={`text-3xl text-[#1D82F5] ${
                isOpen ? 'rotate-180' : ''
              }`}
            />
          </div>
        ...
        <div className="h-[160px] overflow-hidden thin-scrollbar pl-6">
          <div className="overflow-hidden">
            ...
            <div className="flex flex-col text-[#283151] pb-2">
              <span className="font-medium text-sm block aline-center py-1">
                {title}
              </span>
              {linkText ? (
                <Link
